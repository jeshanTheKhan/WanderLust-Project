...
class TestimonialController extends Controller
{
    ...
    public function index(){
        return view('Moderator.Testimonial.index');
    }
    // Insert Data
    ...
    public function table(){
        ...
        return view('Moderator.Testimonial.table',compact('data'));
    }
    // Update Stautsu
    ...
    public function edit($id){
        $data=Testimonial::find($id);
        return view('Moderator.Testimonial.edit',compact('data'));
    }
    // Update
    // Update
    public function update(Request $req){
        ...
        if ($req->file('main_thumbnail')) {
         ...
         return redirect()->route('moderator.all.testimonial')->with($notification);  
    }
    // Delete
