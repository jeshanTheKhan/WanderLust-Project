...
class BlogController extends Controller
{
    ...
    public function index(){
        return view('Moderator.Blog.index');
    }
    // Insert Data
    ...
    public function table(){
        $blog=Blog::all();
        return view('Moderator.Blog.table',compact('blog'));
    }
    // Update Stautsu
    ...
    public function edit($id){
        $data=Blog::find($id);
        return view('Moderator.Blog.edit',compact('data'));
    }
    // Update
    public function update(Request $req){
        ...
        if ($req->file('main_thumbnail')) {
         ...
         return redirect()->route('moderator.all.blog')->with($notification);  
    }
    // Delete
