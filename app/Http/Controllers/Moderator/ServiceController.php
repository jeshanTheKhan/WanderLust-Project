...
class ServiceController extends Controller
{
    ...
    public function index(){
        return view("Moderator.Service.index");
    }
        // Add Services
    ...
    public function table(){
        $service =Service::all();
        return view('Moderator.Service.table',compact('service'));
    }
        ...
        public function edit($id){
            ...
            return view('Moderator.Service.edit',compact('service'));
        }
        // Update
    public function update(Request $req){
       ...
       $store->service_description = $req->description ?? $store->service_description;
        ...
        if ($req->file('main_thumbnail')) {
         ...
         return redirect()->route('moderator.all.services')->with($notification);  
    }
    // Delete
