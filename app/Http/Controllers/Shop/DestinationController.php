...
class DestinationController extends Controller
{
    ...
    public function table(){
        $place = Destination::where('user', Auth::user()->name)->get();
        return view('Shop.Destination.table',compact('place'));
    }
    // Status Update
    ...
    public function update(Request $req){
        ...
        return redirect()->route('shop.all.destination')->with($notification);
    }
    // Delete
