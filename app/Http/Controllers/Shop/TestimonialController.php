...
class TestimonialController extends Controller
{
    ...
    public function index(){
        return view('Shop.Testimonial.index');
    }
    // Insert Data
    ...
    public function table(){
        $data=Testimonial::where('user', Auth::user()->name)->get();
        return view('Shop.Testimonial.table',compact('data'));
    }
    // Update Stautsu
    ...
    public function edit($id){
        $data=Testimonial::find($id);
        return view('Shop.Testimonial.edit',compact('data'));
    }
    // Update
    // Update
    public function update(Request $req){
        ...
        if ($req->file('main_thumbnail')) {
         ...
         return redirect()->route('shop.all.testimonial')->with($notification);  
    }
    // Delete
