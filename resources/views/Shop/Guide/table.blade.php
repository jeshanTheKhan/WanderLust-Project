                        ...
                        <tr>
                            ...
                            <td>
                                @if($data->guide_status == 1)
                                     <form action="{{ route('shop.guide.updatestatus', $data->guide_id) }}" method="POST">
                                @csrf
                            ...
                            <td>
                                <a href="{{ route('shop.guide.edit', $data->guide_id) }}"><i
                                    class="fa fa-pencil"></i></a>
                            <a href="{{ route('shop.guide.del', $data->guide_id) }}"><i
