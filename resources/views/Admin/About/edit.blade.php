        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('admin.update.about') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="first-name" name="header" value="{{ $data->name }}" required="required" class="form-control ">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" name="facebook" value="{{ $data->position }}" required="required" class="form-control ">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" name="instagram" value="{{ $data->hotel_name }}" required="required" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-sm-10">
                                    <img id="studentPhoto" src="{{asset('storage/back/media/about/'.$data->image )}}" style="width: 20%;height:auto;" alt="Avatar" title="Change the avatar">
                                  <div class="col-md-6 col-sm-6">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <textarea id="summernote" name="long_description" required="required" class="form-control">
                                        {!! $data->description !!}
                                    </textarea>
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    ...
                                    <input type="hidden" name="c_id" value="{{ $data->about_id }}">
