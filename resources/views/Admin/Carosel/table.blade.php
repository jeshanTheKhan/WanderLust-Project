                                                ...
                                                <table id="datatable"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                @if($data->status == 1)
                                                                    <form action="{{ route('admin.updateStatus', $data->carosel_id ) }}" method="POST">
                                                                @csrf
                                                            ...
                                                            <td>
                                                                <a href="{{route('admin.edit.carosel',$data->carosel_id)}}"><i
                                                                        class="fa fa-pencil"></i></a>
                                                                <a href="{{route('admin.del.carosel',$data->carosel_id)}}"><i
