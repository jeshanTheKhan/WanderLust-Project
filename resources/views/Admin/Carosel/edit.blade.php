        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('admin.update.carosel') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-sm-10">
                                    <img id="studentPhoto" src="{{asset('storage/back/media/'.$data->images)}}" style="width: 20%;height:auto;" alt="Avatar" title="Change the avatar">
                                  <div class="col-md-6 col-sm-6">
