                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($data->status == 1)
                                     <form action="{{ route('moderator.testimonial.updatestatus', $data->testimonial_id ) }}" method="POST">
                                @csrf
                            ...
                            <td>
                                <a href="{{ route('moderator.testimonial.edit', $data->testimonial_id ) }}"><i
                                    class="fa fa-pencil"></i></a>
                            <a href="{{ route('moderator.testimonial.del', $data->testimonial_id ) }}"><i
