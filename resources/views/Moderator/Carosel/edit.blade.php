        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('moderator.update.carosel') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="first-name" name="header1" value="{{ $data->header1 }}" required="required" class="form-control ">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="last-name" name="header2" value="{{ $data->header2 }}" required="required" class="form-control">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Third Header<span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input id="middle-name" class="form-control" type="text" value="{{ $data->header3 }}" name="header3">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="basic-icon-default-company">Main Thumbnail</label>
                                <div class="col-sm-10">
                                    <img id="studentPhoto" src="{{asset('storage/back/media/carosel/'.$data->images)}}" style="width: 20%;height:auto;" alt="Avatar" title="Change the avatar">
                                  <div class="col-md-6 col-sm-6">
                            ...
                            <input type="hidden" name="c_id" value="{{$data->carosel_id }}">
                            <div class="item form-group">
