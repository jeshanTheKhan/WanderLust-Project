                                                ...
                                                <table id="datatable"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                @if($data->status == 1)
                                                                    <form action="{{ route('moderator.updateStatus', $data->carosel_id ) }}" method="POST">
                                                                @csrf
                                                            ...
                                                            <td>
                                                                <a href="{{route('moderator.edit.carosel',$data->carosel_id)}}"><i
                                                                        class="fa fa-pencil"></i></a>
                                                                <a href="{{route('moderator.del.carosel',$data->carosel_id)}}"><i
