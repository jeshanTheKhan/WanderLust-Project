                        ...
                        <tr>
                            ...
                            <td>
                                @if($data->guide_status == 1)
                                     <form action="{{ route('moderator.guide.updatestatus', $data->guide_id) }}" method="POST">
                                @csrf
                            ...
                            <td>
                                <a href="{{ route('moderator.guide.edit', $data->guide_id) }}"><i
                                    class="fa fa-pencil"></i></a>
                            <a href="{{ route('moderator.guide.del', $data->guide_id) }}"><i
